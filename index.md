...
ComplexHeatmap annotations. These frameworks remain optional. Frozen
ArchR compatibility colors remain available under explicit `archr_*`
palette IDs; scico palettes are also optional and produce an
installation hint only when requested.
