# Frozen verbatim from GreenleafLab/ArchR R/ColorPalettes.R at
# 6feec354ad6c8052ddbc4626a2ca2d858ed465bf.
# Vector order is source order; names retain ArchR's source labels.
archr_palettes <- list(
  stallion = c(
  ...
  zissou = c(
    "1" = "#3B9AB2", "4" = "#78B7C5", "3" = "#EBCC2A",
    "5" = "#E1AF00", "2" = "#F21A00"
  ),
  darjeeling = c(
    "1" = "#FF0000", "2" = "#00A08A", "3" = "#F2AD00",
    "4" = "#F98400", "5" = "#5BBCD6"
  ),
  rushmore = c(
    "1" = "#E1BD6D", "5" = "#EABE94", "2" = "#0B775E",
    "4" = "#35274A", "3" = "#F2300F"
  ),
  captain = c(
    "1" = "grey", "2" = "#A1CDE1", "3" = "#12477C",
    "4" = "#EC9274", "5" = "#67001E"
  ),
  horizon = c(
  ...
  blueYellow = c(
    ...
    "5" = "#2DB7A3", "6" = "#A5BE6A", "7" = "#F8BA43", "8" = "#F6DA23",
    "9" = "#F8FA0D"
  ),
  sambaNight = c(
    "6" = "#1873CC", "2" = "#1798E5", "8" = "#00BFFF", "5" = "#4AC596",
    "1" = "#00CC00", "4" = "#A2E700", "9" = "#FFFF00", "7" = "#FFD200",
    "3" = "#FFA500"
  ),
  solarExtra = c(
    "5" = "#3361A5", "7" = "#248AF3", "1" = "#14B3FF", "8" = "#88CEEF",
    "9" = "#C1D5DC", "4" = "#EAD397", "3" = "#FDB31A", "2" = "#E42A2A",
    "6" = "#A31D1D"
  ),
  whitePurple = c(
    "9" = "#f7fcfd", "6" = "#e0ecf4", "8" = "#bfd3e6", "5" = "#9ebcda",
    "2" = "#8c96c6", "4" = "#8c6bb1", "7" = "#88419d", "3" = "#810f7c",
    "1" = "#4d004b"
  ),
  whiteBlue = c(
    "9" = "#fff7fb", "6" = "#ece7f2", "8" = "#d0d1e6", "5" = "#a6bddb",
    "2" = "#74a9cf", "4" = "#3690c0", "7" = "#0570b0", "3" = "#045a8d",
    "1" = "#023858"
  ),
  ...
  beach = c(
    "4" = "#87D2DB", "1" = "#5BB1CB", "6" = "#4F66AF",
    "3" = "#F15F30", "5" = "#F7962E", "2" = "#FCEE2B"
  ),
  coolwarm = c(
    "1" = "#4858A7", "4" = "#788FC8", "5" = "#D6DAE1",
    "3" = "#F49B7C", "2" = "#B51F29"
  ),
  fireworks = c(
    "5" = "white", "2" = "#2488F0", "4" = "#7F3F98",
    "3" = "#E22929", "1" = "#FCB31A"
  ),
  greyMagma = c(
    "2" = "grey", "4" = "#FB8861FF", "5" = "#B63679FF",
    "3" = "#51127CFF", "1" = "#000004FF"
  ),
  fireworks2 = c(
    "5" = "black", "2" = "#2488F0", "4" = "#7F3F98",
    "3" = "#E22929", "1" = "#FCB31A"
  ),
  purpleOrange = c(
    "5" = "#581845", "2" = "#900C3F", "4" = "#C70039",
    "3" = "#FF5744", "1" = "#FFC30F"
  )
)

archr_discrete <- c(
  "stallion", "stallion2", "calm", "kelly", "bear", "ironMan", "circus",
  "paired", "grove", "summerNight", "zissou", "darjeeling", "rushmore", "captain"
)

archr_borrowed_notes <- c(
  zissou = "Source comment identifies wesanderson.",
  darjeeling = "Source comment identifies wesanderson.",
  rushmore = "Source comment identifies wesanderson.",
  sambaNight = "Source comment identifies buencolors.",
  solarExtra = "Source comment identifies buencolors.",
  whitePurple = "ColorBrewer-derived sequence; provenance review remains.",
  whiteBlue = "ColorBrewer-derived sequence; provenance review remains.",
  greenBlue = "ColorBrewer-derived sequence; provenance review remains."
)
